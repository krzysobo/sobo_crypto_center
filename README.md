...
__ Alice DOES NOT KNOW Bob's SECRET key! Only his public key __



### Alice (her, they) - generation of a Diffie-Hellman's key pair (X25519):
```
    zig run main.zig -- dh_genkey
        There are 2 args:
        /home/krzy/.cache/zig/o/e121ea67a0b5e49a1728dee0a259e262/main
...
__ Bob DOES NOT KNOW Alice's SECRET key! Only her public key __
...
### Alice (her) gets and decrypts the message from Bob. Decryption command format:
