...
pub fn main() !void {
    ...
    try sobocrypto_aes.aesGcmEncrypt(encrypted_text, &aes_gcm_tag, plain_text, buf_key_2, nonce_2, aad_text, nonce_size_bytes, key_size_bytes);

    try sobocrypto_aes.aesGcmDecrypt(decrypted_text, encrypted_text, buf_key_2, aes_gcm_tag, nonce_2, aad_text, nonce_size_bytes, key_size_bytes);
